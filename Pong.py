...
# initialize ball_pos and ball_vel for new ball in middle of table. If direction is RIGHT, the ball's velocity is upper right, else upper left
...
def draw(c):
    ...
    # collide and reflect off of edges and paddles.
    # increase speed 10% if bouncing off a paddle.
